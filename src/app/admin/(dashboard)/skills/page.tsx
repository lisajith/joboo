        ...
        <div className="flex flex-col justify-between gap-5 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="mt-3 text-muted">
              Manage skills used across your job listings.
            </p>
          </div>
        ...
        <div className="mt-10 overflow-hidden rounded-3xl border border-border bg-white">
          ...
          {!error && (!skills || skills.length === 0) && (
            <div className="px-6 py-16 text-center">
              ...
              <h2 className="mt-5 text-xl font-bold">No skills found</h2>

              <p className="mt-2 text-muted">Add your first skill.</p>
            </div>
          )}
              ...
              <table className="w-full min-w-225">
                <thead>
                  <tr className="border-b border-border bg-surface-soft text-left">
                    <th className="px-6 py-4 text-sm font-bold">Skill</th>
                ...
                <tbody>
                  {skills.map((skill) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-5">
                        <span className="text-sm text-muted">{skill.slug}</span>
                      </td>
